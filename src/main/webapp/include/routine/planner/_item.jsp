    ...
    <div id="${planId}-form" class="plan-form collapse">
      <div class="p-1 me-2">
        <div class="d-flex flex-row">
          ...
          <input type="hidden" class="plan-exercise-name" name="${planMapping}[exerciseName]" value="${__exercise.name}" />
          <input type="hidden" class="plan-position" name="${planMapping}[position]" value="${__plan.position}" />
