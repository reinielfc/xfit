  ...
  <form id="planner" action="<c:url value='/planner' />" method="POST">
    <div class="card-header">
      <div class="card-header-tabs nav nav-tabs d-flex justify-content-around" role="tablist">
        <c:forTokens items="${days}" delims="," var="day">
          <button class="nav-link" type="button" data-bs-toggle="tab" data-bs-target="#nav-${day}" role="tab">
            ${fn:toUpperCase(day)}
          </button>
        </c:forTokens>
    ...
    <div class="card-body overflow-auto vh-100 p-0 bg-light">
      <div class="tab-content">
        <c:forTokens items="${days}" delims="," var="day">
          <div id="nav-${day}" class="tab-pane fade p-0" role="tabpanel">
            <!-- Plan List -->
            <ol class="sortable list-group list-group-numbered list-group-flush">
