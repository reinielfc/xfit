...
<div class="d-flex align-items-center px-2">
  ...
  <input id="${__exerciseId}-is-favorite-check" class="exercise-is-favorite-check btn-check" type="checkbox" data-xf-target="#${__exerciseId}" autocomplete="off" ${__favoriteCheck}/>
