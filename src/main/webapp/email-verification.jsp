      ...
      <form action="" method="post">
        <div class="modal-body">
          ...
          <div class="form-group mt-2">
            ...
            <a class="btn text-primary d-inline p-0" href="">
              <small>Send again?</small>
            </a>
            <a class="btn text-primary d-inline p-0" data-bs-toggle="collapse" data-bs-target="#email">
        ...
        <div class="modal-footer">
          <button class="btn btn-secondary">Cancel Registration</button>
