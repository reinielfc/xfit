$(window).on("load", function () {
  ...
  var $activeDayPane = $('#planner .nav .nav-link.active');

  $('#planner .nav .nav-link').on('click', function () {
    $('#planner button.nav-link').attr('data-xf-active', false);
    $(this).attr('data-xf-active', true);
    $activeDayPane = $($(this).data('bs-target'))
  });
